  ...
  return (
    <main className="container mx-auto p-8 max-w-4xl">
      ...
      <div className="prose prose-lg max-w-none">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">2. Allgemeine Hinweise</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-4 mt-8">5. Analyse-Tools und Tools von Drittanbietern</h2>
        <p className="mb-4">
